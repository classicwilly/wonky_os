    ...
    return (
        <ContentCard title="Quest Board" titleClassName="text-accent-blue text-2xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Create Quest Form */}
                <form onSubmit={handleCreateQuest} className="space-y-3 p-4 bg-gray-800 rounded-md border border-gray-700">
                    <h3 className="text-lg font-bold text-accent-green">Create New Quest</h3>
