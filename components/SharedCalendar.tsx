...
const SharedCalendar: React.FC = () => {
    ...
    const selectedIsDadDay = selectedDayMode === 'Family Structure' && selectedDate.getDay() !== 1;

    return (
        <ContentCard title="Shared Co-Parenting Calendar" titleClassName="text-accent-blue text-xl">
